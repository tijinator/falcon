...
class Model_Events
{
	...
	*/
	public function getTable()
	{
		if (null === $this->_table)
		{
			...
			require_once '/var/www/lamp_root/zend_apps/falcon/models/DbTable/Events.php';
			$this->_table = new Model_DbTable_Events;
		}
		return $this->_table;
	}
	...
	* @return object
	*/
	public function getBrandEventsTable()
	{
		//since the dbTable is not a library item but an application item,
		//we must require it to use it
		require_once APPLICATION_PATH .'/models/DbTable/BrandEvents.php';
		return new Model_DbTable_BrandEvents;
	}
